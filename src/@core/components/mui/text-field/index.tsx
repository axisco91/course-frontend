...
const CustomTextField = forwardRef((props: TextFieldProps, ref) => {
  // ** Props
  const { size = 'small', InputLabelProps, InputProps, SelectProps, disabled, inputProps, ...rest } = props
  const lockedInputProps = disabled ? { ...inputProps, readOnly: true, disabled: true } : inputProps
  const lockedInputComponentProps = disabled ? { ...InputProps, readOnly: true } : InputProps
  const lockedSelectProps = disabled ? { ...SelectProps, readOnly: true } : SelectProps
  ...
  return (
    <TextFieldStyled
      ...
      {...rest}
      variant='filled'
      InputProps={lockedInputComponentProps}
      InputLabelProps={{ ...InputLabelProps, shrink: true }}
      SelectProps={lockedSelectProps}
