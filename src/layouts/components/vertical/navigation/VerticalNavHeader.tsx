...
const VerticalNavHeader = (props: Props) => {
  ...
  const layoutTitle = useSelector((state: RootState) => state.layout.title)
  const layoutIcon = useSelector((state: RootState) => state.layout.icon)
  ...
  const icon = layoutIcon || '/images/favicon.png'
