...
const ActionTypesFilters = () => {
  ...
  const filters = useSelector((state: RootState) => (state as any).actionType.filters)

  const handleCreate = () => {
    dispatch(actionTypeActions.setId(null))

    // ✅ abre modal en create
    dispatch(actionTypeActions.openModal({ mode: 'create', actionTypeId: null }))
  }

  const setFilter = (key: string, value: any) => dispatch(actionTypeActions.setFilter({ key, value }))
...
export default ActionTypesFilters
