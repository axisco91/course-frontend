...
import ActionTypesGeneralTab from './ActionTypesGeneralTab'
...
const ActionTypesModel: React.FC<ActionTypeModalProps> = ({ open, onClose, mode, actionTypeId = null }) => {
      ...
      <DialogContent sx={{ pt: 6 }}>
        <Box sx={{ mb: 4, display: 'flex', justifyContent: 'center' }}>
          <Typography variant='h5' sx={{ fontWeight: 700 }}>
            {isCreate ? t('New Action Type') : t('Action Type')}
          </Typography>
        </Box>
...
export default ActionTypesModel
