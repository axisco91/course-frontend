...
const ActionTypesTable = () => {
  ...
  const appliedFilters = useSelector((state: RootState) => (state as any).actionType?.appliedFilters ?? {})
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        e.stopPropagation()
                        blurActiveElement()
                        dispatch(actionTypeActions.openModal({ mode: 'edit' }))
                        dispatch(actionTypeActions.setId(id))
                      }}
                    >
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        ...
                        blurActiveElement()
                        dispatch(actionTypeActions.setId(id))
                        dispatch(actionTypeActions.setShowEliminateDialog(true))
                      }}
                    >
  ...
  const fetchTableData = useCallback(async () => {
    ...
    try {
      ...
      setRows(res.data?.data?.action_types ?? res.data?.data?.data ?? [])
    } catch (error) {
