...
// ** API
import { deleteCenter } from 'src/api/api'
...
const CentersDelete = () => {
  ...
  const showEliminateDialog = useSelector((state: RootState) => state.center.showEliminateDialog)
  ...
  const handleCloseDelete = () => {
    ...
    dispatch(centerActions.setShowEliminateDialog(false))
  }
