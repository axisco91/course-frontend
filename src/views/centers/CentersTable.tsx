...
import { getCenters } from 'src/api/api'
...
const CentersTable = () => {
  ...
  const appliedFilters = useSelector((state: RootState) => (state as any).center?.appliedFilters ?? {})
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        e.stopPropagation()
                        blurActiveElement()
                        dispatch(centerActions.setId(id))
                        dispatch(centerActions.openModal({ mode: 'edit' }))
                      }}
                    >
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        ...
                        blurActiveElement()
                        dispatch(centerActions.setId(id))
                        dispatch(centerActions.setShowEliminateDialog(true))
                      }}
                    >
  ...
  const fetchTableData = useCallback(async () => {
    ...
    try {
      ...
      setRows(res.data?.data?.centers ?? res.data?.data?.data ?? [])
    } catch (error) {
