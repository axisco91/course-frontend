...
// ** API
import { deleteCnae } from 'src/api/api'
...
const CnaesDelete = () => {
  ...
  const showEliminateDialog = useSelector((state: RootState) => state.cnae.showEliminateDialog)
  ...
  const handleCloseDelete = () => {
    ...
    dispatch(cnaeActions.setShowEliminateDialog(false))
  }
