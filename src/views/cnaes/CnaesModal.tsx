...
import CnaesGeneralTab from './CnaesGeneralTab'
...
const CnaesModel: React.FC<CnaeModalProps> = ({ open, onClose, mode, cnaeId = null }) => {
    ...
    >
      ...
      <DialogContent sx={{ pt: 6 }}>
        ...
        <TabPanel value={tab} index={0}>
          <CnaesGeneralTab open={open} mode={effectiveMode} cnaeId={cnaeId ?? null} onClose={onClose} />
        </TabPanel>
      </DialogContent>
    </Dialog>
  )
