...
import { getCnaes } from 'src/api/api'
...
const CnaesTable = () => {
  ...
  const appliedFilters = useSelector((state: RootState) => (state as any).cnae?.appliedFilters ?? {})
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        e.stopPropagation()
                        blurActiveElement()
                        dispatch(cnaeActions.setId(id))
                        dispatch(cnaeActions.openModal({ mode: 'edit' }))
                      }}
                    >
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        ...
                        blurActiveElement()
                        dispatch(cnaeActions.setId(id))
                        dispatch(cnaeActions.setShowEliminateDialog(true))
                      }}
                    >
  ...
  const fetchTableData = useCallback(async () => {
    ...
    try {
      ...
      setRows(res.data?.data?.cnaes ?? res.data?.data?.data ?? [])
    } catch (error) {
