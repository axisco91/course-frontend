...
import { getCommunityFestivals } from 'src/api/api'
...
const CommunityFestivalsTable = () => {
  ...
  const appliedFilters = useSelector((state: RootState) => (state as any).communityFestival?.appliedFilters ?? {})
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        e.stopPropagation()
                        blurActiveElement()
                        dispatch(communityFestivalActions.setId(id))
                        dispatch(communityFestivalActions.setCurrentCommunityFestival(params.row))
                        dispatch(
                          communityFestivalActions.openModal({
                            mode: 'edit',
                            communityFestivalId: id,
                            communityFestival: params.row
                          })
                        )
                      }}
                    >
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        ...
                        blurActiveElement()
                        dispatch(communityFestivalActions.setId(id))
                        dispatch(communityFestivalActions.setShowEliminateDialog(true))
                      }}
                    >
  ...
  const fetchTableData = useCallback(async () => {
    ...
    try {
      ...
      const res = await getCommunityFestivals({
      ...
      setRows(res.data?.data?.community_festivals ?? res.data?.data?.data ?? [])
    } catch (error) {
...
export default CommunityFestivalsTable
