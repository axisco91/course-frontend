...
// ** API
import { deleteCommunity } from 'src/api/api'
...
const CommunitiesDelete = () => {
  const dispatch = useDispatch()
  const { handleError } = useErrorHandler()
  const { logout } = useContext(AuthContext)

  const showEliminateDialog = useSelector((state: RootState) => state.community.showEliminateDialog)
  ...
  const handleCloseDelete = () => {
    ...
    dispatch(communityActions.setShowEliminateDialog(false))
  }
...
export default CommunitiesDelete
