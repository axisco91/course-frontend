...
import CommunitiesGeneralTab from './CommunitiesGeneralTab'
...
const CommunitiesModel: React.FC<CommunityModalProps> = ({ open, onClose, mode, communityId = null }) => {
      ...
      <DialogContent sx={{ pt: 6 }}>
        <Box sx={{ mb: 4, display: 'flex', justifyContent: 'center' }}>
          <Typography variant='h5' sx={{ fontWeight: 700 }}>
            {isCreate ? t('New Community') : t('Community')}
          </Typography>
        </Box>
        ...
        <TabPanel value={tab} index={0}>
          <CommunitiesGeneralTab open={open} mode={effectiveMode} communityId={communityId ?? null} onClose={onClose} />
        </TabPanel>
      </DialogContent>
    </Dialog>
  )
