...
import { getCommunities } from 'src/api/api'
...
const CommunitiesTable = () => {
  ...
  const appliedFilters = useSelector((state: RootState) => (state as any).community?.appliedFilters ?? {})
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        e.stopPropagation()
                        blurActiveElement()
                        dispatch(communityActions.setId(id))
                        dispatch(communityActions.openModal({ mode: 'edit' }))
                      }}
                    >
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        ...
                        blurActiveElement()
                        dispatch(communityActions.setId(id))
                        dispatch(communityActions.setShowEliminateDialog(true))
                      }}
                    >
  ...
  const fetchTableData = useCallback(async () => {
    ...
    try {
      ...
      setRows(res.data?.data?.communities ?? res.data?.data?.data ?? [])
    } catch (error) {
