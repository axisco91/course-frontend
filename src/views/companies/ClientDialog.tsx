...
// ** API
import { convertClient } from 'src/api/api'
...
const ClientDialog = () => {
  ...
  const showClientDialog = useSelector((state: RootState) => state.company.showClientDialog)
  ...
  const handleCloseConfirm = () => {
    ...
    dispatch(companyActions.setShowClientDialog(false))
  }
