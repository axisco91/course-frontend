...
// ** API
import { deleteCompany } from 'src/api/api'
...
const CompaniesDelete = () => {
  ...
  const showEliminateDialog = useSelector((state: RootState) => state.company.showEliminateDialog)

  // ✅ company id (NOT course)
  ...
  const handleCloseDelete = () => {
    ...
    dispatch(companyActions.setShowEliminateDialog(false))
  }
