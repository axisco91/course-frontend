...
// ** API
import { deleteCompanyType } from 'src/api/api'
...
const CompanyTypesDelete = () => {
  ...
  const showEliminateDialog = useSelector((state: RootState) => state.companyType.showEliminateDialog)
  ...
  const handleCloseDelete = () => {
    ...
    dispatch(companyTypeActions.setShowEliminateDialog(false))
  }
...
export default CompanyTypesDelete
