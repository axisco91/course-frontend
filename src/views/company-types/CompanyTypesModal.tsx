...
import CompanyTypesGeneralTab from './CompanyTypesGeneralTab'
...
const CompanyTypesModal: React.FC<CompanyTypeModalProps> = ({ open, onClose, mode, companyTypeId = null }) => {
      ...
      <DialogContent sx={{ pt: 6 }}>
        <Box sx={{ mb: 4, display: 'flex', justifyContent: 'center' }}>
          <Typography variant='h5' sx={{ fontWeight: 700 }}>
            {isCreate ? t('New Company Type') : t('Company Type')}
          </Typography>
        </Box>
