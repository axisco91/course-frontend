...
const CompanyTypesTable = () => {
  ...
  const appliedFilters = useSelector((state: RootState) => (state as any).companyType?.appliedFilters ?? {})
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        e.stopPropagation()
                        blurActiveElement()
                        dispatch(companyTypeActions.setId(id))
                        dispatch(companyTypeActions.openModal({ mode: 'edit' }))
                      }}
                    >
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        ...
                        blurActiveElement()
                        dispatch(companyTypeActions.setId(id))
                        dispatch(companyTypeActions.setShowEliminateDialog(true))
                      }}
                    >
  ...
  const fetchTableData = useCallback(async () => {
    ...
    try {
      ...
      setRows(res.data?.data?.company_types ?? res.data?.data?.data ?? [])
    } catch (error) {
