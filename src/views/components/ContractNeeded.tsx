...
interface ContractNeededProps {
  onClose: () => void
}

const ContractNeeded: React.FC<ContractNeededProps> = ({ onClose }) => {
  // Para el idioma
        ...
        >
          ...
          <Box sx={{ mb: 8, textAlign: 'center' }}>
            ...
            <Typography sx={{ color: 'text.secondary' }}>
              {t('You haven`t been added a contract for this date you need to talk with HR')}
            </Typography>
          </Box>
        </DialogContent>
        <DialogActions
