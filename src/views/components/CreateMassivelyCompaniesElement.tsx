...
interface CreateMassivelyElementProps {
  onClose: () => void
  onDelete: () => void
}

const CreateMassivelyCompaniesElement: React.FC<CreateMassivelyElementProps> = ({ onClose, onDelete }) => {
  // Para el idioma
        ...
        >
          ...
          <Box sx={{ mb: 8, textAlign: 'center' }}>
            <Typography variant='h3' sx={{ mb: 3 }}>
              {t('Create For All Companies')}
            </Typography>
            <Typography sx={{ color: 'text.secondary' }}>
              {t('This will create the element for all the companies')}
            </Typography>
          </Box>
        </DialogContent>
        <DialogActions
...
export default CreateMassivelyCompaniesElement
