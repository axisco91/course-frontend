...
const DeleteAllAutomatics: React.FC<DeleteElementProps> = ({ onClose, onDelete }) => {
  // Para el idioma
        ...
        >
          ...
          <Box sx={{ mb: 8, textAlign: 'center' }}>
            <Typography variant='h3' sx={{ mb: 3 }}>
              {t('Delete Automatic Communications')}
            </Typography>
            <Typography sx={{ color: 'text.secondary' }}>
              {t('Do you want to delete all the automatic communications?')}
            </Typography>
          </Box>
        </DialogContent>
        <DialogActions
...
export default DeleteAllAutomatics
