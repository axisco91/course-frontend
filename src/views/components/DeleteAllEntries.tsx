...
const DeleteAllEntries: React.FC<DeleteElementProps> = ({ onClose, onDelete }) => {
  // Para el idioma
        ...
        >
          ...
          <Box sx={{ mb: 8, textAlign: 'center' }}>
            ...
            <Typography sx={{ color: 'text.secondary' }}>
              {t('Do you want to delete the registries permanently?')}
            </Typography>
            <Typography sx={{ color: 'text.secondary' }}>
              {t('Do you want to delete all records of the day permanently?')}
            </Typography>
          </Box>
        </DialogContent>
        <DialogActions
