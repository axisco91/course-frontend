                  ...
                  <Controller
                    ...
                    render={({ field: { value, onChange } }) => (
                      <CustomTextField
                        ...
                        id='input-week_hours'
                        placeholder={t('Weekly Hours')}
                        error={Boolean(errors.week_hours)}
                        {...(errors.week_hours && { helperText: errors.week_hours.message })}
                        InputProps={{
                          startAdornment: (
                            <InputAdornment position='start'>
                              <IconButton
                                aria-label='decrease'
                                onClick={() => onChange(Number(value) - 1)} // Decrement value
                          ...
                          endAdornment: (
                            <InputAdornment position='end'>
                              <IconButton
                                ...
                                aria-label='increase'
                                onClick={() => onChange(Number(value) + 1)} // Increment value
                                style={{ color: theme.palette.primary.main }}
                              >
