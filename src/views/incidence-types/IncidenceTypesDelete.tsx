...
// ** API
import { deleteIncidenceType } from 'src/api/api'
...
const IncidenceTypesDelete = () => {
  const dispatch = useDispatch()
  const { handleError } = useErrorHandler()
  const { logout } = useContext(AuthContext)

  const showEliminateDialog = useSelector((state: RootState) => state.incidenceType.showEliminateDialog)
  ...
  const handleCloseDelete = () => {
    ...
    dispatch(incidenceTypeActions.setShowEliminateDialog(false))
  }
...
export default IncidenceTypesDelete
