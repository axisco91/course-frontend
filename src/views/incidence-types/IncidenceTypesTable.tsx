...
const IncidenceTypesTable = () => {
  ...
  const appliedFilters = useSelector((state: RootState) => (state as any).incidenceType?.appliedFilters ?? {})
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        e.stopPropagation()
                        blurActiveElement()
                        dispatch(incidenceTypeActions.openModal({ mode: 'edit' }))
                        dispatch(incidenceTypeActions.setId(id))
                      }}
                    >
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        ...
                        blurActiveElement()
                        dispatch(incidenceTypeActions.setId(id))
                        dispatch(incidenceTypeActions.setShowEliminateDialog(true))
                      }}
                    >
  ...
  const fetchTableData = useCallback(async () => {
    ...
    try {
      ...
      const res = await getIncidenceTypes({
      ...
      setRows(res.data?.data?.incidence_types ?? res.data?.data?.data ?? [])
    } catch (error) {
...
export default IncidenceTypesTable
