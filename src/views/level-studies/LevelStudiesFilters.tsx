...
const LevelStudiesFilters = () => {
  ...
  const filters = useSelector((state: RootState) => (state as any).levelStudy.filters)

  const handleCreate = () => {
    dispatch(levelStudyActions.setId(null))

    // ✅ abre modal en create
    dispatch(levelStudyActions.openModal({ mode: 'create', levelStudyId: null }))
  }

  const setFilter = (key: string, value: any) => dispatch(levelStudyActions.setFilter({ key, value }))
...
export default LevelStudiesFilters
