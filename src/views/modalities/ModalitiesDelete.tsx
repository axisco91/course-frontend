...
// ** API
import { deleteModality } from 'src/api/api'
...
const ModalitiesDelete = () => {
  const dispatch = useDispatch()
  const { handleError } = useErrorHandler()
  const { logout } = useContext(AuthContext)

  const showEliminateDialog = useSelector((state: RootState) => state.modality.showEliminateDialog)
  ...
  const handleCloseDelete = () => {
    ...
    dispatch(modalityActions.setShowEliminateDialog(false))
  }
...
export default ModalitiesDelete
