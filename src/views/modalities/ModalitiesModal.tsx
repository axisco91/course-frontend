...
import ModalitiesGeneralTab from './ModalitiesGeneralTab'
...
const ModalitiesModel: React.FC<ModalityModalProps> = ({ open, onClose, mode, modalityId = null }) => {
      ...
      <DialogContent sx={{ pt: 6 }}>
        <Box sx={{ mb: 4, display: 'flex', justifyContent: 'center' }}>
          <Typography variant='h5' sx={{ fontWeight: 700 }}>
            {isCreate ? t('New Modality') : t('Modality')}
          </Typography>
        </Box>
        ...
        <TabPanel value={tab} index={0}>
          <ModalitiesGeneralTab open={open} mode={effectiveMode} modalityId={modalityId ?? null} onClose={onClose} />
        </TabPanel>
      </DialogContent>
    </Dialog>
  )
