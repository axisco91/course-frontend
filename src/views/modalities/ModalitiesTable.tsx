...
import { getModalities } from 'src/api/api'
...
const ModalitiesTable = () => {
  ...
  const appliedFilters = useSelector((state: RootState) => (state as any).modality?.appliedFilters ?? {})
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        e.stopPropagation()
                        blurActiveElement()
                        dispatch(modalityActions.setId(id))
                        dispatch(modalityActions.openModal({ mode: 'edit' }))
                      }}
                    >
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        ...
                        blurActiveElement()
                        dispatch(modalityActions.setId(id))
                        dispatch(modalityActions.setShowEliminateDialog(true))
                      }}
                    >
  ...
  const fetchTableData = useCallback(async () => {
    ...
    try {
      ...
      setRows(res.data?.data?.modalities ?? res.data?.data?.data ?? [])
    } catch (error) {
