...
const NacionalFestivalsFilters = () => {
  ...
  const filters = useSelector((state: RootState) => (state as any).nacionalFestival.filters)

  const handleCreate = () => {
    dispatch(nacionalFestivalActions.setId(null))

    // ✅ abre modal en create
    dispatch(nacionalFestivalActions.openModal({ mode: 'create', nacionalFestivalId: null }))
  }

  const setFilter = (key: string, value: any) => dispatch(nacionalFestivalActions.setFilter({ key, value }))
...
export default NacionalFestivalsFilters
