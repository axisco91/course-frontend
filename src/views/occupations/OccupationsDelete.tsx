...
// ** API
import { deleteOccupation } from 'src/api/api'
...
const OccupationDelete = () => {
  const dispatch = useDispatch()
  const { handleError } = useErrorHandler()
  const { logout } = useContext(AuthContext)

  const showEliminateDialog = useSelector((state: RootState) => state.occupation.showEliminateDialog)
  ...
  const handleCloseDelete = () => {
    ...
    dispatch(occupationActions.setShowEliminateDialog(false))
  }
