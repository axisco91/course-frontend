...
import OccupationsGeneralTab from './OccupationsGeneralTab'
...
const OccupationsModel: React.FC<OccupationModalProps> = ({ open, onClose, mode, occupationId = null }) => {
      ...
      <DialogContent sx={{ pt: 6 }}>
        <Box sx={{ mb: 4, display: 'flex', justifyContent: 'center' }}>
          <Typography variant='h5' sx={{ fontWeight: 700 }}>
            {isCreate ? t('New Occupation') : t('Occupation')}
          </Typography>
        </Box>
...
export default OccupationsModel
