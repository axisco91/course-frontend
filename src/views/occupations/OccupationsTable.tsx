...
import { getOccupations } from 'src/api/api'
...
const OccupationsTable = () => {
  ...
  const appliedFilters = useSelector((state: RootState) => (state as any).occupation?.appliedFilters ?? {})
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        e.stopPropagation()
                        blurActiveElement()
                        dispatch(occupationActions.setId(id))
                        dispatch(occupationActions.openModal({ mode: 'edit' }))
                      }}
                    >
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        ...
                        blurActiveElement()
                        dispatch(occupationActions.setId(id))
                        dispatch(occupationActions.setShowEliminateDialog(true))
                      }}
                    >
  ...
  const fetchTableData = useCallback(async () => {
    ...
    try {
      ...
      setRows(res.data?.data?.occupations ?? res.data?.data?.data ?? [])
    } catch (error) {
