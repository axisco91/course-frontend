...
import OnLeaveTypesGeneralTab from './OnLeaveTypesGeneralTab'
...
const OnLeaveTypesModel: React.FC<ActionTypeModalProps> = ({ open, onClose, mode, onLeaveId = null }) => {
      ...
      <DialogContent sx={{ pt: 6 }}>
        <Box sx={{ mb: 4, display: 'flex', justifyContent: 'center' }}>
          <Typography variant='h5' sx={{ fontWeight: 700 }}>
            {isCreate ? t('New On Leave Type') : t('On Leave Type')}
          </Typography>
        </Box>
        ...
        <TabPanel value={tab} index={0}>
          <OnLeaveTypesGeneralTab open={open} mode={effectiveMode} onLeaveId={onLeaveId ?? null} onClose={onClose} />
        </TabPanel>
      </DialogContent>
    </Dialog>
  )
...
export default OnLeaveTypesModel
