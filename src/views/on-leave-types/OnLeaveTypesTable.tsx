...
const OnLeaveTypesTable = () => {
  ...
  const appliedFilters = useSelector((state: RootState) => (state as any).onLeave?.appliedFilters ?? {})
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        e.stopPropagation()
                        blurActiveElement()
                        dispatch(onLeaveActions.openModal({ mode: 'edit' }))
                        dispatch(onLeaveActions.setId(id))
                      }}
                    >
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        ...
                        blurActiveElement()
                        dispatch(onLeaveActions.setId(id))
                        dispatch(onLeaveActions.setShowEliminateDialog(true))
                      }}
                    >
  ...
  const fetchTableData = useCallback(async () => {
    ...
    try {
      ...
      const res = await getOnLeaveTypes({
      ...
      setRows(res.data?.data?.on_leave_types ?? res.data?.data?.data ?? [])
    } catch (error) {
...
export default OnLeaveTypesTable
