...
import { getPayments } from 'src/api/api'
...
const PaymentsTable = () => {
  ...
  const appliedFilters = useSelector((state: RootState) => (state as any).payment?.appliedFilters ?? {})
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        e.stopPropagation()
                        blurActiveElement()
                        dispatch(paymentActions.setId(id))
                        dispatch(paymentActions.openModal({ mode: 'edit' }))
                      }}
                    >
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        ...
                        blurActiveElement()
                        dispatch(paymentActions.setId(id))
                        dispatch(paymentActions.setShowEliminateDialog(true))
                      }}
                    >
  ...
  const fetchTableData = useCallback(async () => {
    ...
    try {
      ...
      setRows(res.data?.data?.payments ?? res.data?.data?.data ?? [])
    } catch (error) {
