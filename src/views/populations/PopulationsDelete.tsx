...
// ** API
import { deletePopulation } from 'src/api/api'
...
const PopulationsDelete = () => {
  const dispatch = useDispatch()
  const { handleError } = useErrorHandler()
  const { logout } = useContext(AuthContext)

  const showEliminateDialog = useSelector((state: RootState) => state.population.showEliminateDialog)
  ...
  const handleCloseDelete = () => {
    ...
    dispatch(populationActions.setShowEliminateDialog(false))
  }
...
export default PopulationsDelete
