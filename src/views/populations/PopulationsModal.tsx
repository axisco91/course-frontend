...
import PopulationsGeneralTab from './PopulationsGeneralTab'
...
const PopulationsModal: React.FC<PopulationModalProps> = ({ open, onClose, mode, populationId = null }) => {
