...
// ** API
import { getPopulations } from 'src/api/api'
...
const PopulationsTable = () => {
  ...
  // filtros aplicados (si los tienes)
  const appliedFilters = useSelector((state: RootState) => (state as any).population?.appliedFilters ?? {})
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        e.stopPropagation()
                        blurActiveElement()
                        dispatch(populationActions.setId(id))
                        dispatch(populationActions.openModal({ mode: 'edit' }))
                      }}
                    >
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        ...
                        blurActiveElement()
                        dispatch(populationActions.setId(id))
                        dispatch(populationActions.setShowEliminateDialog(true))
                      }}
                    >
  ...
  const fetchTableData = useCallback(async () => {
    ...
    try {
      ...
      setRows(res.data?.data?.populations ?? res.data?.data?.data ?? [])
    } catch (error) {
