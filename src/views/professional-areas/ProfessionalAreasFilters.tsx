...
const ProfessionalAreasFilters = () => {
  ...
  const filters = useSelector((state: RootState) => (state as any).professionalArea.filters)

  const handleCreate = () => {
    dispatch(professionalAreaActions.setId(null))

    // ✅ abre modal en create
    dispatch(professionalAreaActions.openModal({ mode: 'create', professionalAreaId: null }))
  }

  const setFilter = (key: string, value: any) => dispatch(professionalAreaActions.setFilter({ key, value }))
...
export default ProfessionalAreasFilters
