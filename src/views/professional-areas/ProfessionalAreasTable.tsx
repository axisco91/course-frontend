...
const ProfessionalAreasTable = () => {
  ...
  const appliedFilters = useSelector((state: RootState) => (state as any).professionalArea?.appliedFilters ?? {})
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        e.stopPropagation()
                        blurActiveElement()
                        dispatch(professionalAreaActions.setId(id))
                        dispatch(professionalAreaActions.openModal({ mode: 'edit' }))
                      }}
                    >
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        ...
                        blurActiveElement()
                        dispatch(professionalAreaActions.setId(id))
                        dispatch(professionalAreaActions.setShowEliminateDialog(true))
                      }}
                    >
  ...
  const fetchTableData = useCallback(async () => {
    ...
    try {
      ...
      const res = await getProfessionalAreas({
      ...
      setRows(res.data?.data?.professional_areas ?? res.data?.data?.data ?? [])
    } catch (error) {
...
export default ProfessionalAreasTable
