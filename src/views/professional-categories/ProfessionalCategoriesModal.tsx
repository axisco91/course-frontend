...
import ProfessionalCategoriesGeneralTab from './ProfessionalCategoriesGeneralTab'
...
const ProfessionalCategoriesModel: React.FC<ProfessionalCategoryModalProps> = ({
  open,
  onClose,
  mode,
      ...
      <DialogContent sx={{ pt: 6 }}>
        <Box sx={{ mb: 4, display: 'flex', justifyContent: 'center' }}>
          <Typography variant='h5' sx={{ fontWeight: 700 }}>
            {isCreate ? t('New Professional Category') : t('Professional Category')}
          </Typography>
        </Box>
        ...
        <TabPanel value={tab} index={0}>
          <ProfessionalCategoriesGeneralTab
            open={open}
            mode={effectiveMode}
            professionalCategoryId={professionalCategoryId ?? null}
            onClose={onClose}
          />
        </TabPanel>
      </DialogContent>
...
export default ProfessionalCategoriesModel
