...
import ProfessionalFamiliesGeneralTab from './ProfessionalFamiliesGeneralTab'
...
interface ProfessionalFamilyModalProps {
  open: boolean
  onClose: () => void
  mode: Mode
...
const ProfessionalFamiliesModel: React.FC<ProfessionalFamilyModalProps> = ({
  open,
  onClose,
  mode,
      ...
      <DialogContent sx={{ pt: 6 }}>
        <Box sx={{ mb: 4, display: 'flex', justifyContent: 'center' }}>
          <Typography variant='h5' sx={{ fontWeight: 700 }}>
            {isCreate ? t('New Professional Family') : t('Professional Family')}
          </Typography>
        </Box>
        ...
        <TabPanel value={tab} index={0}>
          <ProfessionalFamiliesGeneralTab
            open={open}
            mode={effectiveMode}
            professionalFamilyId={professionalFamilyId ?? null}
            onClose={onClose}
          />
        </TabPanel>
      </DialogContent>
...
export default ProfessionalFamiliesModel
