...
const ProfessionalFamiliesTable = () => {
  ...
  const appliedFilters = useSelector((state: RootState) => (state as any).professionalFamily?.appliedFilters ?? {})
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        e.stopPropagation()
                        blurActiveElement()
                        dispatch(professionalFamilyActions.setId(id))
                        dispatch(professionalFamilyActions.openModal({ mode: 'edit' }))
                      }}
                    >
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        ...
                        blurActiveElement()
                        dispatch(professionalFamilyActions.setId(id))
                        dispatch(professionalFamilyActions.setShowEliminateDialog(true))
                      }}
                    >
  ...
  const fetchTableData = useCallback(async () => {
    ...
    try {
      ...
      const res = await getProfessionalFamilies({
      ...
      setRows(res.data?.data?.professional_families ?? res.data?.data?.data ?? [])
    } catch (error) {
...
export default ProfessionalFamiliesTable
