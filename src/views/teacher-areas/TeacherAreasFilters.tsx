...
const TeacherAreasFilters = () => {
  ...
  const filters = useSelector((state: RootState) => (state as any).teacherArea.filters)

  const handleCreate = () => {
    dispatch(teacherAreaActions.setId(null))

    // ✅ abre modal en create
    dispatch(teacherAreaActions.openModal({ mode: 'create', teacherAreaId: null }))
  }

  const setFilter = (key: string, value: any) => dispatch(teacherAreaActions.setFilter({ key, value }))
...
export default TeacherAreasFilters
