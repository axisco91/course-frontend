...
const TeacherAreasTable = () => {
  ...
  const appliedFilters = useSelector((state: RootState) => (state as any).teacherArea?.appliedFilters ?? {})
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        e.stopPropagation()
                        blurActiveElement()
                        dispatch(teacherAreaActions.setId(id))
                        dispatch(teacherAreaActions.openModal({ mode: 'edit' }))
                      }}
                    >
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        ...
                        blurActiveElement()
                        dispatch(teacherAreaActions.setId(id))
                        dispatch(teacherAreaActions.setShowEliminateDialog(true))
                      }}
                    >
  ...
  const fetchTableData = useCallback(async () => {
    ...
    try {
      ...
      const res = await getTeacherAreas({
      ...
      setRows(res.data?.data?.teacher_areas ?? res.data?.data?.data ?? [])
    } catch (error) {
...
export default TeacherAreasTable
