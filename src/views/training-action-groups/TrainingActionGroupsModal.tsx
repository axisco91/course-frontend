...
import TrainingActionGroupsGeneralTab from './TrainingActionGroupsGeneralTab'
...
interface TrainingActionGroupModalProps {
  open: boolean
  onClose: () => void
  mode: Mode
...
const TrainingActionGroupsModel: React.FC<TrainingActionGroupModalProps> = ({
  open,
  onClose,
  mode,
  trainingActionGroupId = null
}) => {
    ...
    >
      ...
      <DialogContent sx={{ pt: 6 }}>
        ...
        <TabPanel value={tab} index={0}>
          <TrainingActionGroupsGeneralTab
            open={open}
            mode={effectiveMode}
            trainingActionGroupId={trainingActionGroupId ?? null}
            onClose={onClose}
          />
        </TabPanel>
      </DialogContent>
...
export default TrainingActionGroupsModel
