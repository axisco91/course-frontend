// src/views/GroupStudies/GroupStudyComponents/GroupStudiesTable.tsx
...
const TrainingActionGroupsTable = () => {
  ...
  const appliedFilters = useSelector((state: RootState) => (state as any).trainingActionGroup?.appliedFilters ?? {})
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        e.stopPropagation()
                        blurActiveElement()
                        dispatch(trainingActionGroupActions.setId(id))
                        dispatch(trainingActionGroupActions.openModal({ mode: 'edit' }))
                      }}
                    >
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        ...
                        blurActiveElement()
                        dispatch(trainingActionGroupActions.setId(id))
                        dispatch(trainingActionGroupActions.setShowEliminateDialog(true))
                      }}
                    >
  ...
  const fetchTableData = useCallback(async () => {
    ...
    try {
      ...
      const res = await getTrainingActionGroups({
      ...
      setRows(res.data?.data?.training_action_groups ?? res.data?.data?.data ?? [])
    } catch (error) {
...
export default TrainingActionGroupsTable
