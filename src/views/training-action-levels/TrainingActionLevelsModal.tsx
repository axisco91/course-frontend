...
import TrainingActionLevelsGeneralTab from './TrainingActionLevelsGeneralTab'
...
interface TrainingActionLevelModalProps {
  open: boolean
  onClose: () => void
  mode: Mode
...
const TrainingActionLevelsModel: React.FC<TrainingActionLevelModalProps> = ({
  open,
  onClose,
  mode,
  trainingActionLevelId = null
}) => {
    ...
    >
      ...
      <DialogContent sx={{ pt: 6 }}>
        ...
        <TabPanel value={tab} index={0}>
          <TrainingActionLevelsGeneralTab
            open={open}
            mode={effectiveMode}
            trainingActionLevelId={trainingActionLevelId ?? null}
            onClose={onClose}
          />
        </TabPanel>
      </DialogContent>
...
export default TrainingActionLevelsModel
