...
const TrainingActionLevelsTable = () => {
  ...
  const appliedFilters = useSelector((state: RootState) => (state as any).trainingActionLevel?.appliedFilters ?? {})
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        e.stopPropagation()
                        blurActiveElement()
                        dispatch(trainingActionLevelActions.setId(id))
                        dispatch(trainingActionLevelActions.openModal({ mode: 'edit' }))
                      }}
                    >
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        ...
                        blurActiveElement()
                        dispatch(trainingActionLevelActions.setId(id))
                        dispatch(trainingActionLevelActions.setShowEliminateDialog(true))
                      }}
                    >
  ...
  const fetchTableData = useCallback(async () => {
    ...
    try {
      ...
      const res = await getTrainingActionLevels({
      ...
      setRows(res.data?.data?.training_action_levels ?? res.data?.data?.data ?? [])
    } catch (error) {
...
export default TrainingActionLevelsTable
