...
const TutoringsTable = () => {
  ...
  const appliedFilters = useSelector((state: RootState) => (state as any).tutoring?.appliedFilters ?? {})
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        e.stopPropagation()
                        blurActiveElement()
                        dispatch(tutoringActions.setId(id))
                        dispatch(tutoringActions.openModal({ mode: 'edit' }))
                      }}
                    >
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        ...
                        blurActiveElement()
                        dispatch(tutoringActions.setId(id))
                        dispatch(tutoringActions.setShowEliminateDialog(true))
                      }}
                    >
  ...
  const fetchTableData = useCallback(async () => {
    ...
    try {
      ...
      setRows(res.data?.data?.tutorings ?? res.data?.data?.data ?? [])
    } catch (error) {
