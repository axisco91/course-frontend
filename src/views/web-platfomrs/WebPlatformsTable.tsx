...
const WebPlatformsTable = () => {
  ...
  const appliedFilters = useSelector((state: RootState) => (state as any).webPlatform?.appliedFilters ?? {})
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        e.stopPropagation()
                        blurActiveElement()
                        dispatch(webPlatformActions.setId(id))
                        dispatch(webPlatformActions.openModal({ mode: 'edit' }))
                      }}
                    >
                  ...
                  <span>
                    <IconButton
                      ...
                      onClick={e => {
                        ...
                        blurActiveElement()
                        dispatch(webPlatformActions.setId(id))
                        dispatch(webPlatformActions.setShowEliminateDialog(true))
                      }}
                    >
  ...
  const fetchTableData = useCallback(async () => {
    ...
    try {
      ...
      const res = await getWebPlatforms({
      ...
      setRows(res.data?.data?.web_platforms ?? res.data?.data?.data ?? [])
    } catch (error) {
...
export default WebPlatformsTable
